...
const PowerCup = () => {
  ...
  useEffect(() => {
    const loadPlayers = async () => {
      const roster = await fetchPowerCupPlayers();
      setPlayers(roster);
    };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10 space-y-10">
        <section className="rounded-3xl bg-gradient-to-br from-sky-600 via-cyan-500 to-emerald-500 p-10 text-white shadow-xl">
          <div className="flex flex-wrap items-center justify-between gap-6">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-white/70">2026</p>
              <h1 className="text-4xl font-black tracking-tight">Power cup</h1>
            </div>
            <div className="flex items-center gap-4 rounded-2xl bg-white/10 p-4 backdrop-blur">
              ...
              <div>
                ...
                <p className="text-xl font-semibold text-white">11-12 april</p>
              </div>
            </div>
            <div className="flex items-center gap-4 rounded-2xl bg-white/10 p-4 backdrop-blur">
        ...
        <section className="space-y-8">
          <Card className="border-cyan-100 shadow-lg">
            <CardHeader className="flex flex-row items-start justify-between">
              <CardTitle className="text-2xl">Grupp-tabell</CardTitle>
            </CardHeader>
          ...
          <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">Preliminärt gruppspel</p>
              </CardHeader>
